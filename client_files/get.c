...
/*   Updated: 2017/05/08 17:08:39 by nahmed-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "client.h"

void	show_download_bar(unsigned int count, unsigned int size)
{
	static int 		i;

	i = 0;
	printf("\rDownloading (%d %%) ... [===]", i++);
//	while ((size / count * 10) > i)
//	{
//		printf("=");
//		i++;
//	}
